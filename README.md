...
- **CWIST (classic pool)**: 111899 req/s | Latency 2.03ms (P90 4.22ms, P99 10.13ms) | RSS 14168KiB | Csw 0
- **CWIST (C1M reactor)**: 110879 req/s | Latency 2.16ms (P90 4.49ms, P99 10.06ms) | RSS 9824KiB | Csw 0
- **Axum**: 111041 req/s | Latency 3.52ms (P90 5.94ms, P99 8.80ms) | RSS 15228KiB | Csw 0
- **Gin (Go)**: 78390 req/s | Latency 6.82ms (P90 16.43ms, P99 36.31ms) | RSS 30028KiB | Csw 0
- **Spring Boot**: 42323 req/s | Latency 9.40ms (P90 12.22ms, P99 19.76ms) | RSS 1355748KiB | Csw 0
