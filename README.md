...
- **CWIST (classic pool)**: 153109 req/s | Latency 1.48ms (P90 3.14ms, P99 7.00ms) | RSS 14476KiB | Csw 0
- **CWIST (C1M reactor)**: 153042 req/s | Latency 1.59ms (P90 3.32ms, P99 7.94ms) | RSS 9456KiB | Csw 0
- **Axum**: 155346 req/s | Latency 2.46ms (P90 4.36ms, P99 6.80ms) | RSS 15512KiB | Csw 0
- **Gin (Go)**: 117117 req/s | Latency 4.40ms (P90 10.50ms, P99 21.87ms) | RSS 29592KiB | Csw 0
- **Spring Boot**: 72562 req/s | Latency 5.54ms (P90 7.65ms, P99 14.85ms) | RSS 1313480KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 149,619 req/s at 0.41ms average latency (P50 0.34ms, P90 0.71ms, P99 1.84ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
