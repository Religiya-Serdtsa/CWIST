...
- **CWIST (classic pool)**: 112197 req/s | Latency 1.98ms (P90 4.09ms, P99 8.70ms) | RSS 15892KiB | Csw 0
- **CWIST (C1M reactor)**: 112609 req/s | Latency 2.14ms (P90 4.45ms, P99 9.25ms) | RSS 7144KiB | Csw 0
- **Axum**: 112172 req/s | Latency 3.42ms (P90 5.82ms, P99 8.81ms) | RSS 15288KiB | Csw 0
- **Gin (Go)**: 78576 req/s | Latency 7.04ms (P90 17.33ms, P99 38.93ms) | RSS 30064KiB | Csw 0
- **Spring Boot**: 42517 req/s | Latency 9.36ms (P90 12.10ms, P99 20.80ms) | RSS 1351428KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 108,800 req/s at 0.55ms average latency (P50 0.47ms, P90 0.96ms, P99 2.00ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
