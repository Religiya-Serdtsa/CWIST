...
- **CWIST (classic pool)**: 203315 req/s | Latency 1.22ms (P90 2.57ms, P99 8.62ms) | RSS 14752KiB | Csw 0
- **CWIST (C1M reactor)**: 193706 req/s | Latency 1.31ms (P90 2.74ms, P99 7.44ms) | RSS 10516KiB | Csw 0
- **Axum**: 197507 req/s | Latency 1.99ms (P90 3.54ms, P99 5.52ms) | RSS 15272KiB | Csw 0
- **Gin (Go)**: 142316 req/s | Latency 4.95ms (P90 13.32ms, P99 31.34ms) | RSS 29352KiB | Csw 0
- **Spring Boot**: 94818 req/s | Latency 4.27ms (P90 6.21ms, P99 12.31ms) | RSS 1316572KiB | Csw 0
