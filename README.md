...
- **CWIST (classic pool)**: 58731 req/s | Latency 6.96ms (P90 14.79ms, P99 21.94ms) | RSS 32436KiB | Csw 0
- **CWIST (C1M reactor)**: 153069 req/s | Latency 2.88ms (P90 7.95ms, P99 16.83ms) | RSS 39420KiB | Csw 0
- **Axum**: 156328 req/s | Latency 2.52ms (P90 4.44ms, P99 6.78ms) | RSS 15696KiB | Csw 0
- **Gin (Go)**: 117868 req/s | Latency 4.27ms (P90 10.05ms, P99 20.89ms) | RSS 29632KiB | Csw 0
- **Spring Boot**: 76890 req/s | Latency 5.22ms (P90 6.96ms, P99 10.95ms) | RSS 1310224KiB | Csw 0
