...
- **CWIST**: 122572 req/s | Latency 3.12ms (P90 8.28ms, P99 16.63ms) | RSS 17496KiB | Csw 0
- **Axum**: 121765 req/s | Latency 3.12ms (P90 5.38ms, P99 8.17ms) | RSS 14752KiB | Csw 0
- **Gin (Go)**: 92980 req/s | Latency 5.41ms (P90 12.68ms, P99 26.97ms) | RSS 29536KiB | Csw 0
- **Spring Boot**: 58690 req/s | Latency 6.79ms (P90 8.98ms, P99 15.19ms) | RSS 1293320KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 106,824 req/s at 0.59ms average latency (P50 0.46ms, P90 1.18ms, P99 2.54ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
