...
- **CWIST (classic pool)**: 40717 req/s | Latency 9.90ms (P90 20.29ms, P99 30.89ms) | RSS 32280KiB | Csw 0
- **CWIST (C1M reactor)**: 117372 req/s | Latency 3.29ms (P90 8.64ms, P99 17.00ms) | RSS 39324KiB | Csw 0
- **Axum**: 111609 req/s | Latency 3.48ms (P90 5.91ms, P99 8.82ms) | RSS 16072KiB | Csw 0
- **Gin (Go)**: 75275 req/s | Latency 7.27ms (P90 17.65ms, P99 40.30ms) | RSS 29732KiB | Csw 0
- **Spring Boot**: 42839 req/s | Latency 9.35ms (P90 12.10ms, P99 18.93ms) | RSS 1327804KiB | Csw 0
