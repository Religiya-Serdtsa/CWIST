...
- **CWIST (classic pool)**: 219313 req/s | Latency 1.07ms (P90 2.26ms, P99 5.29ms, P99.999 0.00ms) | RSS 18232KiB | Csw 0
- **CWIST (C1M reactor)**: 239642 req/s | Latency 1.88ms (P90 5.37ms, P99 15.66ms, P99.999 0.00ms) | RSS 9904KiB | Csw 0
- **Axum**: 223344 req/s | Latency 1.77ms (P90 3.13ms, P99 4.89ms, P99.999 0.00ms) | RSS 14632KiB | Csw 0
- **Gin (Go)**: 168620 req/s | Latency 3.84ms (P90 10.14ms, P99 22.50ms, P99.999 0.00ms) | RSS 30336KiB | Csw 0
- **Spring Boot**: 118371 req/s | Latency 3.37ms (P90 4.91ms, P99 7.57ms, P99.999 0.00ms) | RSS 1305552KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 226,038 req/s at 0.34ms average latency (P50 0.18ms, P90 0.75ms, P99 2.44ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
