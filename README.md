...
- **CWIST (classic pool)**: 118073 req/s | Latency 2.02ms (P90 3.90ms, P99 8.15ms) | RSS 211096KiB | Csw 0
- **CWIST (C1M reactor)**: 119582 req/s | Latency 2.01ms (P90 4.12ms, P99 9.61ms) | RSS 32592KiB | Csw 0
- **Axum**: 119762 req/s | Latency 3.27ms (P90 5.59ms, P99 8.38ms) | RSS 15844KiB | Csw 0
- **Gin (Go)**: 90853 req/s | Latency 5.46ms (P90 12.66ms, P99 26.41ms) | RSS 29848KiB | Csw 0
- **Spring Boot**: 59304 req/s | Latency 6.73ms (P90 8.79ms, P99 15.06ms) | RSS 1324644KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 115,136 req/s at 0.53ms average latency (P50 0.44ms, P90 0.94ms, P99 2.15ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
