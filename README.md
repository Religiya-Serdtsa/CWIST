...
- **CWIST (classic pool)**: 113115 req/s | Latency 1.91ms (P90 3.94ms, P99 7.73ms) | RSS 15700KiB | Csw 0
- **CWIST (C1M reactor)**: 112602 req/s | Latency 2.14ms (P90 4.36ms, P99 9.48ms) | RSS 8208KiB | Csw 0
- **Axum**: 111546 req/s | Latency 3.52ms (P90 5.92ms, P99 8.81ms) | RSS 16900KiB | Csw 0
- **Gin (Go)**: 77388 req/s | Latency 6.90ms (P90 16.68ms, P99 36.73ms) | RSS 30832KiB | Csw 0
- **Spring Boot**: 43530 req/s | Latency 9.14ms (P90 11.72ms, P99 19.01ms) | RSS 1336332KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 110,214 req/s at 0.54ms average latency (P50 0.47ms, P90 0.96ms, P99 2.02ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
