...
- **CWIST (classic pool)**: 115807 req/s | Latency 1.80ms (P90 3.82ms, P99 7.70ms) | RSS 14388KiB | Csw 0
- **CWIST (C1M reactor)**: 113650 req/s | Latency 2.15ms (P90 4.39ms, P99 9.86ms) | RSS 9344KiB | Csw 0
- **Axum**: 114011 req/s | Latency 3.45ms (P90 5.84ms, P99 8.76ms) | RSS 16020KiB | Csw 0
- **Gin (Go)**: 80489 req/s | Latency 6.43ms (P90 15.07ms, P99 34.31ms) | RSS 29908KiB | Csw 0
- **Spring Boot**: 44200 req/s | Latency 9.06ms (P90 11.82ms, P99 19.23ms) | RSS 1336112KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 113,670 req/s at 0.52ms average latency (P50 0.46ms, P90 0.86ms, P99 1.89ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
