...
- **CWIST (classic pool)**: 155441 req/s | Latency 1.38ms (P90 2.88ms, P99 5.96ms, P99.999 19.75ms) | RSS 16208KiB | Csw 0
- **CWIST (C1M reactor)**: 161468 req/s | Latency 2.28ms (P90 6.17ms, P99 16.09ms, P99.999 27.76ms) | RSS 10460KiB | Csw 0
- **Axum**: 154317 req/s | Latency 2.53ms (P90 4.44ms, P99 6.74ms, P99.999 12.99ms) | RSS 17228KiB | Csw 0
- **Gin (Go)**: 114126 req/s | Latency 4.60ms (P90 11.03ms, P99 23.85ms, P99.999 49.25ms) | RSS 30584KiB | Csw 0
- **Spring Boot**: 74142 req/s | Latency 5.37ms (P90 7.36ms, P99 11.29ms, P99.999 55.77ms) | RSS 1323068KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 154,182 req/s at 0.43ms average latency (P50 0.28ms, P90 0.86ms, P99 2.32ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
