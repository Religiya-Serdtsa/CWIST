...
- **CWIST**: 248482 req/s | Latency 2.18ms (P90 6.35ms, P99 14.89ms) | RSS 17488KiB | Csw 0
- **Axum**: 237006 req/s | Latency 1.68ms (P90 3.01ms, P99 4.74ms) | RSS 15496KiB | Csw 0
- **Gin (Go)**: 197476 req/s | Latency 3.42ms (P90 9.11ms, P99 20.92ms) | RSS 28804KiB | Csw 0
- **Spring Boot**: 125186 req/s | Latency 3.19ms (P90 4.56ms, P99 7.01ms) | RSS 1321152KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 232,574 req/s at 0.31ms average latency (P50 0.19ms, P90 0.64ms, P99 2.07ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
