...
- **CWIST (classic pool)**: 199581 req/s | Latency 1.11ms (P90 2.40ms, P99 6.36ms) | RSS 14864KiB | Csw 0
- **CWIST (C1M reactor)**: 205937 req/s | Latency 1.14ms (P90 2.34ms, P99 7.76ms) | RSS 11004KiB | Csw 0
- **Axum**: 199149 req/s | Latency 1.99ms (P90 3.53ms, P99 5.50ms) | RSS 16460KiB | Csw 0
- **Gin (Go)**: 147315 req/s | Latency 4.60ms (P90 12.26ms, P99 28.13ms) | RSS 28536KiB | Csw 0
- **Spring Boot**: 97952 req/s | Latency 4.27ms (P90 5.96ms, P99 15.22ms) | RSS 1304204KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 207,737 req/s at 0.31ms average latency (P50 0.23ms, P90 0.55ms, P99 1.69ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
