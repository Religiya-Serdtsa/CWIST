...
- **CWIST (classic pool)**: 174452 req/s | Latency 1.47ms (P90 3.13ms, P99 7.75ms) | RSS 23040KiB | Csw 0
- **CWIST (C1M reactor)**: 170136 req/s | Latency 1.60ms (P90 3.52ms, P99 8.63ms) | RSS 17156KiB | Csw 0
- **Axum**: 168692 req/s | Latency 2.35ms (P90 4.12ms, P99 6.35ms) | RSS 15504KiB | Csw 0
- **Gin (Go)**: 116256 req/s | Latency 6.21ms (P90 16.78ms, P99 39.75ms) | RSS 29428KiB | Csw 0
- **Spring Boot**: 73825 req/s | Latency 5.46ms (P90 7.20ms, P99 12.34ms) | RSS 1310924KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 169,712 req/s at 0.41ms average latency (P50 0.28ms, P90 0.84ms, P99 2.33ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
