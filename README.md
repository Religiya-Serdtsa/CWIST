...
- **CWIST (classic pool)**: 109486 req/s | Latency 2.10ms (P90 4.39ms, P99 8.71ms) | RSS 15808KiB | Csw 0
- **CWIST (C1M reactor)**: 112180 req/s | Latency 2.08ms (P90 4.22ms, P99 8.50ms) | RSS 8200KiB | Csw 0
- **Axum**: 109469 req/s | Latency 3.56ms (P90 6.04ms, P99 8.96ms) | RSS 14888KiB | Csw 0
- **Gin (Go)**: 77258 req/s | Latency 7.38ms (P90 18.30ms, P99 41.96ms) | RSS 29860KiB | Csw 0
- **Spring Boot**: 42688 req/s | Latency 9.41ms (P90 12.00ms, P99 20.57ms) | RSS 1330344KiB | Csw 0
