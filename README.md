...
- **CWIST (classic pool)**: 116833 req/s | Latency 2.07ms (P90 4.09ms, P99 8.54ms) | RSS 21748KiB | Csw 0
- **CWIST (C1M reactor)**: 114001 req/s | Latency 2.25ms (P90 4.82ms, P99 10.34ms) | RSS 15940KiB | Csw 0
- **Axum**: 119175 req/s | Latency 3.25ms (P90 5.54ms, P99 8.40ms) | RSS 15620KiB | Csw 0
- **Gin (Go)**: 89881 req/s | Latency 5.35ms (P90 12.16ms, P99 25.08ms) | RSS 28876KiB | Csw 0
- **Spring Boot**: 56274 req/s | Latency 7.06ms (P90 9.40ms, P99 15.11ms) | RSS 1313376KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 110,493 req/s at 0.58ms average latency (P50 0.44ms, P90 1.15ms, P99 2.58ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
