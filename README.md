...
- **CWIST (classic pool)**: 118023 req/s | Latency 1.79ms (P90 3.75ms, P99 7.69ms) | RSS 14160KiB | Csw 0
- **CWIST (C1M reactor)**: 116301 req/s | Latency 2.06ms (P90 4.19ms, P99 9.87ms) | RSS 8768KiB | Csw 0
- **Axum**: 118991 req/s | Latency 3.30ms (P90 5.60ms, P99 8.46ms) | RSS 15928KiB | Csw 0
- **Gin (Go)**: 87184 req/s | Latency 5.92ms (P90 14.16ms, P99 29.74ms) | RSS 30012KiB | Csw 0
- **Spring Boot**: 57273 req/s | Latency 6.92ms (P90 9.09ms, P99 14.97ms) | RSS 1327820KiB | Csw 0
