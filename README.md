...
- **CWIST (classic pool)**: 121994 req/s | Latency 1.63ms (P90 3.54ms, P99 8.10ms) | RSS 15452KiB | Csw 0
- **CWIST (C1M reactor)**: 118885 req/s | Latency 1.99ms (P90 3.96ms, P99 8.51ms) | RSS 11512KiB | Csw 0
- **Axum**: 120887 req/s | Latency 3.21ms (P90 5.46ms, P99 8.16ms) | RSS 16036KiB | Csw 0
- **Gin (Go)**: 91224 req/s | Latency 5.54ms (P90 13.03ms, P99 27.29ms) | RSS 29372KiB | Csw 0
- **Spring Boot**: 59854 req/s | Latency 6.62ms (P90 8.78ms, P99 14.12ms) | RSS 1305912KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 116,023 req/s at 0.51ms average latency (P50 0.44ms, P90 0.90ms, P99 2.03ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
