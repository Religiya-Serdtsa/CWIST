...
- **CWIST (classic pool)**: 43715 req/s | Latency 9.32ms (P90 19.74ms, P99 29.86ms) | RSS 31696KiB | Csw 0
- **CWIST (C1M reactor)**: 116005 req/s | Latency 3.33ms (P90 8.70ms, P99 16.78ms) | RSS 39248KiB | Csw 0
- **Axum**: 119438 req/s | Latency 3.27ms (P90 5.53ms, P99 8.20ms) | RSS 16080KiB | Csw 0
- **Gin (Go)**: 87463 req/s | Latency 5.92ms (P90 14.09ms, P99 30.00ms) | RSS 28840KiB | Csw 0
- **Spring Boot**: 58233 req/s | Latency 6.86ms (P90 9.28ms, P99 16.07ms) | RSS 1313160KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 115,035 req/s at 0.71ms average latency (P50 0.39ms, P90 1.79ms, P99 3.57ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
