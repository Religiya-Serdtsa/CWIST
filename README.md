...
- **CWIST (classic pool)**: 154006 req/s | Latency 1.44ms (P90 3.08ms, P99 7.23ms) | RSS 16208KiB | Csw 0
- **CWIST (C1M reactor)**: 152181 req/s | Latency 1.68ms (P90 3.53ms, P99 9.71ms) | RSS 9428KiB | Csw 0
- **Axum**: 153627 req/s | Latency 2.57ms (P90 4.54ms, P99 6.93ms) | RSS 16324KiB | Csw 0
- **Gin (Go)**: 117705 req/s | Latency 4.42ms (P90 10.67ms, P99 22.17ms) | RSS 30604KiB | Csw 0
- **Spring Boot**: 76247 req/s | Latency 5.18ms (P90 7.00ms, P99 10.30ms) | RSS 1297348KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 148,695 req/s at 0.39ms average latency (P50 0.32ms, P90 0.70ms, P99 1.77ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
