...
- **CWIST (classic pool)**: 182589 req/s | Latency 1.27ms (P90 2.65ms, P99 6.84ms) | RSS 17364KiB | Csw 0
- **CWIST (C1M reactor)**: 180931 req/s | Latency 1.55ms (P90 3.36ms, P99 10.26ms) | RSS 11024KiB | Csw 0
- **Axum**: 173499 req/s | Latency 2.28ms (P90 4.00ms, P99 6.09ms) | RSS 17244KiB | Csw 0
- **Gin (Go)**: 120175 req/s | Latency 5.74ms (P90 15.18ms, P99 37.31ms) | RSS 29592KiB | Csw 0
- **Spring Boot**: 74267 req/s | Latency 5.39ms (P90 7.00ms, P99 12.32ms) | RSS 1298640KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 179,463 req/s at 0.35ms average latency (P50 0.28ms, P90 0.63ms, P99 1.87ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
