...
- **CWIST (classic pool)**: 259795 req/s | Latency 0.96ms (P90 1.82ms, P99 6.43ms) | RSS 196288KiB | Csw 0
- **CWIST (C1M reactor)**: 248862 req/s | Latency 1.05ms (P90 2.15ms, P99 6.72ms) | RSS 41472KiB | Csw 0
- **Axum**: 259468 req/s | Latency 1.53ms (P90 2.74ms, P99 4.39ms) | RSS 16012KiB | Csw 0
- **Gin (Go)**: 199223 req/s | Latency 3.46ms (P90 9.20ms, P99 21.60ms) | RSS 28544KiB | Csw 0
- **Spring Boot**: 132751 req/s | Latency 2.98ms (P90 4.28ms, P99 6.15ms) | RSS 1317408KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 278,899 req/s at 0.19ms average latency (P50 0.15ms, P90 0.32ms, P99 1.15ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
