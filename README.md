...
- **CWIST (classic pool)**: 115289 req/s | Latency 1.97ms (P90 4.02ms, P99 8.35ms) | RSS 15864KiB | Csw 0
- **CWIST (C1M reactor)**: 113382 req/s | Latency 2.11ms (P90 4.23ms, P99 9.15ms) | RSS 7604KiB | Csw 0
- **Axum**: 112752 req/s | Latency 3.40ms (P90 5.79ms, P99 8.67ms) | RSS 16508KiB | Csw 0
- **Gin (Go)**: 78059 req/s | Latency 7.22ms (P90 18.02ms, P99 39.97ms) | RSS 29944KiB | Csw 0
- **Spring Boot**: 43490 req/s | Latency 9.16ms (P90 11.69ms, P99 19.04ms) | RSS 1340864KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 110,455 req/s at 0.52ms average latency (P50 0.45ms, P90 0.89ms, P99 2.00ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
