...
- **CWIST (classic pool)**: 115988 req/s | Latency 2.12ms (P90 4.40ms, P99 11.13ms) | RSS 18088KiB | Csw 0
- **CWIST (C1M reactor)**: 117900 req/s | Latency 2.02ms (P90 4.15ms, P99 9.35ms) | RSS 8720KiB | Csw 0
- **Axum**: 118885 req/s | Latency 3.30ms (P90 5.64ms, P99 8.44ms) | RSS 16556KiB | Csw 0
- **Gin (Go)**: 86120 req/s | Latency 6.15ms (P90 14.65ms, P99 33.32ms) | RSS 29952KiB | Csw 0
- **Spring Boot**: 56347 req/s | Latency 7.09ms (P90 9.28ms, P99 16.27ms) | RSS 1307872KiB | Csw 0
