...
- **CWIST**: 114730 req/s | Latency 3.25ms (P90 8.19ms, P99 17.48ms) | RSS 16300KiB | Csw 0
- **Axum**: 113850 req/s | Latency 3.41ms (P90 5.79ms, P99 8.57ms) | RSS 15456KiB | Csw 0
- **Gin (Go)**: 78602 req/s | Latency 6.62ms (P90 15.78ms, P99 33.99ms) | RSS 29632KiB | Csw 0
- **Spring Boot**: 43918 req/s | Latency 9.20ms (P90 11.87ms, P99 21.12ms) | RSS 1307764KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 99,399 req/s at 0.66ms average latency (P50 0.50ms, P90 1.36ms, P99 2.84ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
