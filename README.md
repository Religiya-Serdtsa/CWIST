...
- **CWIST**: 110236 req/s | Latency 0.14ms (P90 0.26ms, P99 0.82ms) | RSS 15688KiB | Csw 0
- **Axum**: 110312 req/s | Latency 3.56ms (P90 6.02ms, P99 9.11ms) | RSS 17476KiB | Csw 0
- **Gin (Go)**: 77441 req/s | Latency 6.47ms (P90 15.06ms, P99 32.28ms) | RSS 29196KiB | Csw 0
- **Spring Boot**: 43016 req/s | Latency 9.24ms (P90 12.03ms, P99 19.78ms) | RSS 1328424KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 110,407 req/s at 0.10ms average latency (P50 0.08ms, P90 0.16ms, P99 0.28ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
