...
- **CWIST**: 113752 req/s | Latency 3.34ms (P90 8.68ms, P99 17.21ms) | RSS 15820KiB | Csw 0
- **Axum**: 113349 req/s | Latency 3.46ms (P90 5.87ms, P99 8.77ms) | RSS 15620KiB | Csw 0
- **Gin (Go)**: 78857 req/s | Latency 6.83ms (P90 16.40ms, P99 37.56ms) | RSS 29888KiB | Csw 0
- **Spring Boot**: 44009 req/s | Latency 9.06ms (P90 11.79ms, P99 19.17ms) | RSS 1347280KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 99,148 req/s at 0.65ms average latency (P50 0.51ms, P90 1.32ms, P99 2.72ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
