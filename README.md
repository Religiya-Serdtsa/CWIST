...
- **CWIST (classic pool)**: 151371 req/s | Latency 1.52ms (P90 3.20ms, P99 7.15ms) | RSS 15768KiB | Csw 0
- **CWIST (C1M reactor)**: 152628 req/s | Latency 1.59ms (P90 3.27ms, P99 7.87ms) | RSS 9348KiB | Csw 0
- **Axum**: 154276 req/s | Latency 2.55ms (P90 4.47ms, P99 6.87ms) | RSS 16840KiB | Csw 0
- **Gin (Go)**: 115428 req/s | Latency 4.64ms (P90 11.22ms, P99 24.51ms) | RSS 30560KiB | Csw 0
- **Spring Boot**: 68591 req/s | Latency 5.91ms (P90 8.42ms, P99 17.01ms) | RSS 1318900KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 154,703 req/s at 0.41ms average latency (P50 0.34ms, P90 0.69ms, P99 1.83ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
