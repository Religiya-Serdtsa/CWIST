...
- **CWIST (classic pool)**: 207953 req/s | Latency 1.16ms (P90 2.36ms, P99 6.95ms) | RSS 15732KiB | Csw 0
- **CWIST (C1M reactor)**: 222621 req/s | Latency 1.16ms (P90 2.50ms, P99 7.82ms) | RSS 10552KiB | Csw 0
- **Axum**: 220747 req/s | Latency 1.80ms (P90 3.23ms, P99 5.11ms) | RSS 16676KiB | Csw 0
- **Gin (Go)**: 166840 req/s | Latency 4.12ms (P90 11.13ms, P99 24.85ms) | RSS 29704KiB | Csw 0
- **Spring Boot**: 112255 req/s | Latency 3.61ms (P90 5.17ms, P99 10.20ms) | RSS 1302604KiB | Csw 0
