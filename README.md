...
- **CWIST**: 111524 req/s | Latency 0.14ms (P90 0.27ms, P99 0.92ms) | RSS 15236KiB | Csw 0
- **Axum**: 108436 req/s | Latency 3.62ms (P90 6.11ms, P99 9.15ms) | RSS 17340KiB | Csw 0
- **Gin (Go)**: 73299 req/s | Latency 7.88ms (P90 19.57ms, P99 45.85ms) | RSS 29192KiB | Csw 0
- **Spring Boot**: 41277 req/s | Latency 9.63ms (P90 12.72ms, P99 21.84ms) | RSS 1343548KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 116,523 req/s at 0.11ms average latency (P50 0.09ms, P90 0.18ms, P99 0.42ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
