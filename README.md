...
- **CWIST (classic pool)**: 113515 req/s | Latency 1.97ms (P90 4.16ms, P99 8.42ms) | RSS 15292KiB | Csw 0
- **CWIST (C1M reactor)**: 112556 req/s | Latency 2.12ms (P90 4.32ms, P99 9.32ms) | RSS 8804KiB | Csw 0
- **Axum**: 111521 req/s | Latency 3.48ms (P90 5.91ms, P99 8.79ms) | RSS 15868KiB | Csw 0
- **Gin (Go)**: 78858 req/s | Latency 6.76ms (P90 16.39ms, P99 35.70ms) | RSS 29420KiB | Csw 0
- **Spring Boot**: 44468 req/s | Latency 8.94ms (P90 11.78ms, P99 18.57ms) | RSS 1305440KiB | Csw 0
