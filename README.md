...
- **CWIST (classic pool)**: 260802 req/s | Latency 0.84ms (P90 1.78ms, P99 5.28ms) | RSS 14300KiB | Csw 0
- **CWIST (C1M reactor)**: 249710 req/s | Latency 0.98ms (P90 2.08ms, P99 6.22ms) | RSS 9964KiB | Csw 0
- **Axum**: 246645 req/s | Latency 1.61ms (P90 2.88ms, P99 4.61ms) | RSS 15536KiB | Csw 0
- **Gin (Go)**: 196077 req/s | Latency 3.36ms (P90 9.01ms, P99 19.48ms) | RSS 28712KiB | Csw 0
- **Spring Boot**: 132360 req/s | Latency 2.99ms (P90 4.48ms, P99 6.80ms) | RSS 1334524KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 281,518 req/s at 0.23ms average latency (P50 0.18ms, P90 0.38ms, P99 1.51ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
