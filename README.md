...
- **CWIST (classic pool)**: 107715 req/s | Latency 1.99ms (P90 4.33ms, P99 9.24ms) | RSS 16684KiB | Csw 0
- **CWIST (C1M reactor)**: 111684 req/s | Latency 2.11ms (P90 4.32ms, P99 9.40ms) | RSS 13932KiB | Csw 0
- **Axum**: 110116 req/s | Latency 3.55ms (P90 5.94ms, P99 8.89ms) | RSS 15900KiB | Csw 0
- **Gin (Go)**: 75642 req/s | Latency 7.16ms (P90 17.26ms, P99 39.15ms) | RSS 29704KiB | Csw 0
- **Spring Boot**: 43285 req/s | Latency 9.17ms (P90 12.07ms, P99 18.90ms) | RSS 1294916KiB | Csw 0
