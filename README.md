...
- **CWIST (classic pool)**: 57698 req/s | Latency 7.10ms (P90 14.95ms, P99 22.54ms) | RSS 32436KiB | Csw 0
- **CWIST (C1M reactor)**: 154803 req/s | Latency 2.85ms (P90 7.82ms, P99 16.66ms) | RSS 39364KiB | Csw 0
- **Axum**: 156711 req/s | Latency 2.44ms (P90 4.34ms, P99 6.79ms) | RSS 14176KiB | Csw 0
- **Gin (Go)**: 118437 req/s | Latency 4.28ms (P90 10.05ms, P99 21.66ms) | RSS 29652KiB | Csw 0
- **Spring Boot**: 76142 req/s | Latency 5.19ms (P90 7.12ms, P99 10.57ms) | RSS 1301316KiB | Csw 0
