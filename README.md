...
- **CWIST (classic pool)**: 112858 req/s | Latency 1.94ms (P90 4.04ms, P99 8.03ms) | RSS 16884KiB | Csw 0
- **CWIST (C1M reactor)**: 112157 req/s | Latency 2.10ms (P90 4.36ms, P99 9.71ms) | RSS 12008KiB | Csw 0
- **Axum**: 110428 req/s | Latency 3.56ms (P90 5.99ms, P99 8.93ms) | RSS 15296KiB | Csw 0
- **Gin (Go)**: 78489 req/s | Latency 6.93ms (P90 16.99ms, P99 37.12ms) | RSS 29888KiB | Csw 0
- **Spring Boot**: 43506 req/s | Latency 9.25ms (P90 12.17ms, P99 21.27ms) | RSS 1322104KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 112,398 req/s at 0.54ms average latency (P50 0.48ms, P90 0.91ms, P99 1.95ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
