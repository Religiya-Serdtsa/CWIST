...
- **CWIST (classic pool)**: 110945 req/s | Latency 1.72ms (P90 3.75ms, P99 7.29ms) | RSS 17080KiB | Csw 0
- **CWIST (C1M reactor)**: 111001 req/s | Latency 2.16ms (P90 4.45ms, P99 9.88ms) | RSS 10932KiB | Csw 0
- **Axum**: 109346 req/s | Latency 3.59ms (P90 6.07ms, P99 9.08ms) | RSS 15800KiB | Csw 0
- **Gin (Go)**: 75096 req/s | Latency 7.60ms (P90 18.81ms, P99 44.42ms) | RSS 30392KiB | Csw 0
- **Spring Boot**: 42113 req/s | Latency 9.50ms (P90 12.37ms, P99 21.31ms) | RSS 1306004KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 108,777 req/s at 0.56ms average latency (P50 0.48ms, P90 1.00ms, P99 2.07ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
