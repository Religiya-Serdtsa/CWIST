...
- **CWIST**: 91628 req/s | Latency 0.07ms (P90 0.09ms, P99 0.11ms) | RSS 14564KiB | Csw 0
- **Axum**: 123631 req/s | Latency 3.36ms (P90 4.29ms, P99 11.04ms) | RSS 15168KiB | Csw 0
- **Gin (Go)**: 73120 req/s | Latency 5.52ms (P90 8.27ms, P99 13.43ms) | RSS 28024KiB | Csw 0
- **Spring Boot**: 32442 req/s | Latency 12.88ms (P90 12.27ms, P99 34.41ms) | RSS 1289080KiB | Csw 0
...
**Tuned low-latency run (CWIST_WORKERS=2 (pinned to 0-1), wrk -t2 -c100 -d10s pinned to 2-3 (after 10s warmup, warmup discarded)): 58,261 req/s at 0.05ms average latency (P50 0.05ms, P90 0.06ms, P99 0.07ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
