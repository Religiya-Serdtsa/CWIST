...
- **CWIST (classic pool)**: 115207 req/s | Latency 1.73ms (P90 3.75ms, P99 7.77ms) | RSS 16096KiB | Csw 0
- **CWIST (C1M reactor)**: 117147 req/s | Latency 2.01ms (P90 4.07ms, P99 9.08ms) | RSS 10300KiB | Csw 0
- **Axum**: 119837 req/s | Latency 3.27ms (P90 5.58ms, P99 8.33ms) | RSS 17012KiB | Csw 0
- **Gin (Go)**: 84409 req/s | Latency 6.55ms (P90 15.97ms, P99 36.81ms) | RSS 30384KiB | Csw 0
- **Spring Boot**: 57976 req/s | Latency 6.83ms (P90 9.14ms, P99 14.32ms) | RSS 1320224KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 115,976 req/s at 0.50ms average latency (P50 0.42ms, P90 0.89ms, P99 2.00ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
