...
- **CWIST (classic pool)**: 43868 req/s | Latency 9.53ms (P90 20.92ms, P99 30.58ms) | RSS 32864KiB | Csw 0
- **CWIST (C1M reactor)**: 116746 req/s | Latency 3.29ms (P90 8.69ms, P99 16.59ms) | RSS 39216KiB | Csw 0
- **Axum**: 121627 req/s | Latency 3.22ms (P90 5.46ms, P99 8.09ms) | RSS 17752KiB | Csw 0
- **Gin (Go)**: 89645 req/s | Latency 5.84ms (P90 13.94ms, P99 30.55ms) | RSS 29420KiB | Csw 0
- **Spring Boot**: 54489 req/s | Latency 7.44ms (P90 9.96ms, P99 18.96ms) | RSS 1303896KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 113,876 req/s at 0.68ms average latency (P50 0.40ms, P90 1.68ms, P99 3.33ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
