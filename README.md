...
- **CWIST (classic pool)**: 150081 req/s | Latency 1.86ms (P90 4.16ms, P99 13.41ms) | RSS 21544KiB | Csw 0
- **CWIST (C1M reactor)**: 146750 req/s | Latency 1.80ms (P90 3.77ms, P99 9.27ms) | RSS 15376KiB | Csw 0
- **Axum**: 155486 req/s | Latency 2.54ms (P90 4.45ms, P99 6.80ms) | RSS 15852KiB | Csw 0
- **Gin (Go)**: 118093 req/s | Latency 4.27ms (P90 10.10ms, P99 20.85ms) | RSS 30604KiB | Csw 0
- **Spring Boot**: 70840 req/s | Latency 5.63ms (P90 8.12ms, P99 13.80ms) | RSS 1299440KiB | Csw 0
