...
- **CWIST (classic pool)**: 117643 req/s | Latency 1.82ms (P90 3.74ms, P99 7.25ms) | RSS 16848KiB | Csw 0
- **CWIST (C1M reactor)**: 118620 req/s | Latency 2.02ms (P90 4.14ms, P99 8.98ms) | RSS 12924KiB | Csw 0
- **Axum**: 119756 req/s | Latency 3.23ms (P90 5.51ms, P99 8.28ms) | RSS 15216KiB | Csw 0
- **Gin (Go)**: 90085 req/s | Latency 5.64ms (P90 13.24ms, P99 28.60ms) | RSS 29564KiB | Csw 0
- **Spring Boot**: 57260 req/s | Latency 6.95ms (P90 9.37ms, P99 15.70ms) | RSS 1315808KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 115,573 req/s at 0.53ms average latency (P50 0.44ms, P90 0.94ms, P99 2.08ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
