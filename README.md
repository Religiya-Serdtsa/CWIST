...
- **CWIST (classic pool)**: 108201 req/s | Latency 2.11ms (P90 4.49ms, P99 9.14ms) | RSS 16116KiB | Csw 0
- **CWIST (C1M reactor)**: 109744 req/s | Latency 2.20ms (P90 4.43ms, P99 9.63ms) | RSS 11492KiB | Csw 0
- **Axum**: 108675 req/s | Latency 3.61ms (P90 6.08ms, P99 9.11ms) | RSS 16336KiB | Csw 0
- **Gin (Go)**: 75570 req/s | Latency 7.03ms (P90 16.93ms, P99 36.72ms) | RSS 29948KiB | Csw 0
- **Spring Boot**: 42887 req/s | Latency 9.25ms (P90 12.04ms, P99 18.72ms) | RSS 1318468KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 108,007 req/s at 0.52ms average latency (P50 0.45ms, P90 0.90ms, P99 1.96ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
