...
- **CWIST (classic pool)**: 116368 req/s | Latency 1.94ms (P90 4.03ms, P99 7.47ms, P99.999 24.10ms) | RSS 16212KiB | Csw 0
- **CWIST (C1M reactor)**: 122512 req/s | Latency 2.75ms (P90 7.13ms, P99 16.83ms, P99.999 47.99ms) | RSS 10308KiB | Csw 0
- **Axum**: 111785 req/s | Latency 3.51ms (P90 5.89ms, P99 8.73ms, P99.999 17.24ms) | RSS 16588KiB | Csw 0
- **Gin (Go)**: 81130 req/s | Latency 6.75ms (P90 16.46ms, P99 36.16ms, P99.999 75.53ms) | RSS 30440KiB | Csw 0
- **Spring Boot**: 43732 req/s | Latency 9.15ms (P90 12.25ms, P99 19.23ms, P99.999 88.84ms) | RSS 1297744KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 113,752 req/s at 0.56ms average latency (P50 0.40ms, P90 1.14ms, P99 2.48ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
