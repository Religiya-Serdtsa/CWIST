...
- **CWIST (classic pool)**: 77609 req/s | Latency 5.41ms (P90 11.79ms, P99 17.81ms) | RSS 32868KiB | Csw 0
- **CWIST (C1M reactor)**: 193813 req/s | Latency 2.41ms (P90 6.82ms, P99 15.42ms) | RSS 39284KiB | Csw 0
- **Axum**: 184987 req/s | Latency 2.14ms (P90 3.83ms, P99 6.00ms) | RSS 16344KiB | Csw 0
- **Gin (Go)**: 132180 req/s | Latency 5.14ms (P90 13.68ms, P99 31.25ms) | RSS 29424KiB | Csw 0
- **Spring Boot**: 95233 req/s | Latency 4.21ms (P90 5.87ms, P99 10.40ms) | RSS 1316912KiB | Csw 0
...
**Tuned low-latency run (wrk -t4 -c100 -d10s (after 10s warmup, warmup discarded)): 189,528 req/s at 0.48ms average latency (P50 0.23ms, P90 1.30ms, P99 2.78ms).** Leaving headroom between server workers and load-generator threads keeps the latency tail flat — oversubscribing the same cores shows a multi-ms average from scheduling jitter alone at similar throughput.
<!-- TUNED_BENCHMARK:END -->
