...
- **CWIST (classic pool)**: 115334 req/s | Latency 1.83ms (P90 3.95ms, P99 8.37ms) | RSS 13560KiB | Csw 0
- **CWIST (C1M reactor)**: 113694 req/s | Latency 2.11ms (P90 4.38ms, P99 9.39ms) | RSS 10904KiB | Csw 0
- **Axum**: 110365 req/s | Latency 3.46ms (P90 5.87ms, P99 8.85ms) | RSS 13792KiB | Csw 0
- **Gin (Go)**: 79253 req/s | Latency 6.76ms (P90 16.30ms, P99 36.43ms) | RSS 30012KiB | Csw 0
- **Spring Boot**: 44772 req/s | Latency 8.97ms (P90 11.75ms, P99 18.21ms) | RSS 1313732KiB | Csw 0
