...
- **CWIST (classic pool)**: 114560 req/s | Latency 2.02ms (P90 4.15ms, P99 7.74ms, P99.999 26.97ms) | RSS 16756KiB | Csw 0
- **CWIST (C1M reactor)**: 121782 req/s | Latency 2.50ms (P90 5.99ms, P99 14.83ms, P99.999 31.59ms) | RSS 10164KiB | Csw 0
- **Axum**: 111981 req/s | Latency 3.51ms (P90 5.89ms, P99 8.70ms, P99.999 15.27ms) | RSS 16796KiB | Csw 0
- **Gin (Go)**: 78005 req/s | Latency 7.51ms (P90 18.83ms, P99 43.89ms, P99.999 84.28ms) | RSS 30540KiB | Csw 0
- **Spring Boot**: 44157 req/s | Latency 9.08ms (P90 11.66ms, P99 19.11ms, P99.999 110.04ms) | RSS 1307904KiB | Csw 0
